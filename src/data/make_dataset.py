...
#for 1000 dataset: converting data at frequency of 200ms then apply aggregate function on it
data_merged[:1000].resample(rule="200ms").apply(sampling)

# Split by day (requried so that it doesn't take interval for those data which are not present in dataset)
# otherwise it will give Nan for those data
